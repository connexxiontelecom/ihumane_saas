...
<nav class="navbar navbar-expand-lg main-navbar">
  <form class="form-inline mr-auto" onsubmit="return false;">
    ...
    <li class="dropdown dropdown-list-toggle">
      ...
      <div class="dropdown-menu dropdown-list dropdown-menu-right">
<!--        <div class="dropdown-header">Help Center</div>-->
<!--        <div class="dropdown-list-content dropdown-list-message">-->
<!--          <a href="#" class="dropdown-item">IHUMANE Documentation</a>-->
...
<!--        </div>-->
<!--        <div class="dropdown-footer text-center">-->
<!--          <small>Visit <a href="https://ihumane.net">ihumane.net<i class="fas fa-chevron-right"></i></a></small>-->
<!--        </div>-->
      </div>
    </li>

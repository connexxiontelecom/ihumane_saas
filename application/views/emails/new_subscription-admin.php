							...
							<tr>
								<td class="content-cell">
									<div class="f-fallback">
										...
										<p>We have a new Subscription to iHumane.</p>
										<!-- Action -->

										<p>Just to Remind you, here's your login information:</p>

										<p><?php echo $name; ?> has  just subscribed to a <?php echo $plan_name; ?> Plan for <?php echo $plan_duration; ?> days.</p>
